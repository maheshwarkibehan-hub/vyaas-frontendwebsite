...
class ConversationMemory:
    ...
    def __init__(self, user_id: str, storage_path: str = "history"):
        self.user_id = user_id
        self.storage_path = storage_path
        
        # Create user-specific directory: history/{user_id}
        self.user_folder = os.path.join(storage_path, user_id)
        os.makedirs(self.user_folder, exist_ok=True)
        
        # File path: history/{user_id}/chat.json
        self.memory_file = os.path.join(self.user_folder, "chat.json")
